...
public class IntegrationBigBang extends Utils {
    ...
    @Test
    public void BigBangTesting() throws IOException, NoSuchFieldException, IllegalAccessException {
        BufferedWriter out = Mockito.mock(BufferedWriter.class);
        ...
        Mockito.when(input.readLine()).thenReturn( "1", "Nume", "Prenume", "1810202812345", "LECTURER", "3308", "1", "Nume", "Prenume", "1810303812345", "LECTURER", "3308", "2", "1810303", "3", "4");
